...
<cfmail TO="nutritionist@maxvite.com" FROM="nutritionist@maxvite.com" subject="Nutritionist Request from Web Site" server="#Application.mailserver#" username="#Application.mailuser#" password="#Application.mailpassword#">
