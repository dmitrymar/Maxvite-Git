...
<cfinclude template="../meta10.cfm">
<link rel="stylesheet" href="css/listpage-d.css">
...
<div class="wrapper">
  ...
  <div class="content">
    <div class="primary"> <a href="/shipping.html" id="freeShipBnr"><img src="/img/free-ship-bnr.gif" alt=""></a> <a name="topOfPage"></a>
      <h1>Search Results for: "<cfoutput>#q#</cfoutput>"</h1>
      <br />
      <p></p>
      <div id="listProductsWrap">Loading Products...</div>
      <br>
      <p class="small">*These statements have not been evaluated by the Food and Drug Administration. These products is not intended to diagnose, treat, cure, or prevent any diseases.</p>
    </div>
    <!--end primary-->
...
<cfoutput>
var Searchkeywords = {
	query: "/dev/search-query-d.cfm?q=#q#"
}
</cfoutput>
</script>
...
<script src="js/searchcontroller-d.js"></script>
</body>
</html>