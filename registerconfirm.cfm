...
<cfmail to="#email#" from="maxvite@maxvite.com" subject="Thank you for signing up with MaxVite.com!" server="#Application.mailserver#" username="#Application.mailuser#" password="#Application.mailpassword#" type="HTML">
